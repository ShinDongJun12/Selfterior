<?php 
    ...
    // 집구경 게시물 제목 or 내용에 검색 키워드가 포함되어 있는 집구경 게시물의 데이터를 조회한다. OR post_content LIKE '%$searchKeyWord%'
    $sql = "SELECT * FROM house_tour_post WHERE post_title LIKE '%$searchKeyWord%' OR post_content LIKE '%$searchKeyWord%'";
