<?php 
    ...
    // user_pass 없음
    $result=mysqli_query($conn, "INSERT INTO members(user_email,user_pass,user_unique_identifier,user_nickname,profile_image,user_regtime,platform_type,user_token) VALUES ('$userEmail','','$userIdentifier','$userNickname','$profile_image',now(),'$userPlatformType','$userToken')");
    ...
    if($result){
        ...
        if($exist > 0){
            ...
            $sql2 = "SELECT user_num FROM members WHERE user_nickname='".$_POST['userNickname']."'"; 
