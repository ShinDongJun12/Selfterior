<?php
    ...
    {
        $sql = "SELECT * FROM post order by post_regtime desc limit $limit offset $page";
    }
    // 특정 게시글 불러올 경우.
    else
    {
        $sql = "SELECT * FROM post WHERE post_category = '$category_filter' order by post_regtime desc limit $limit offset $page";
    }
