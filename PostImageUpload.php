<?php
    ...
    $sql1 = "INSERT INTO house_tour_post (user_num, post_title, post_content, post_img_path, post_regtime)";
    $sql1.= " VALUES ($userNum, '$postTitle', '$postContent', 'mmm', now())";
    ...
    if($res1) {
        ...
        if (!is_dir($postDirPath)) {
            ...
            $sql2 = "UPDATE house_tour_post SET post_img_path = '$uriList', post_regtime = now() WHERE post_num = $get_post_num";
            ...
            if($res2) {
                ...
                $sql = "SELECT * FROM house_tour_post WHERE post_num = $get_post_num";
                ...
                // while($post = $res->fetch_assoc()) { 
                    ...
                    $sql_user2 = "select * from comments where post_num = $post[post_num] and category = '집구경'";
        ...
        // 폴더가 존재하면 
            ...
            // DB에 게시물의 post_img_path, post_regtime 값을 추가적으로 저장한다.
            $sql3 = "UPDATE house_tour_post SET post_img_path = '$uriList2', post_regtime = now() WHERE post_num = $get_post_num";
