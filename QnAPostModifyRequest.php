<?php
    ...
    $sql = "SELECT * FROM qna_post WHERE post_num = $postNum"; 
    ...
    if($exist > 0){    
        ...
        $postUploadDir = "qnaPostImages"; // 집구경 게시물 이미지 저장할 폴더명
        ...
        $sql1 = "UPDATE qna_post SET post_category ='$postCategory', post_title ='$postTitle', post_content ='$contentList', post_imgPath = '$urlList' WHERE post_num = $postNum";
        ...
        if($res1) {
            ...
            while($post_info = $res->fetch_assoc()) { 
                ...
                $data = [
                    ...
                    'post_thumbnail_image' => $post_info['post_imgPath'], // 게시물 이미지 URL 목록들
